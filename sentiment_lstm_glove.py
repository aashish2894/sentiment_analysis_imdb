...
checkpointer = ModelCheckpoint(filepath="weights_lstm.hdf5", verbose=1, save_best_only=True)

model.fit(x_train, y_train, validation_data=(x_val, y_val), epochs=2, callbacks=[checkpointer], batch_size=64)
